...
namespace DotNetFrameworkWebApp.DataTable.Extension
{
    ...
    public class DataTableResultExt : ActionResult, IDataTableResult<List<DataTableRow>>
    {
        ...
        public DataTableResultExt(DotNetFrameworkWebApp.DataTable.DataTable dataTable, int iTotalRecords = 0, int iTotalDisplayRecords = 0, List<DataTableRow> aaData = null)
