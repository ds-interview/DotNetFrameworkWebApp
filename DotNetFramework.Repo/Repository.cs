...
namespace DotNetFramework.Repo
{
     public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public Repository(JobrecruitmentEntities context)
        {
            Context = context;
        ...
        public virtual void Update(TEntity entity) //here
        {
            DbSet.Attach(entity);
        ...
        public virtual void Delete(object id)    //here
        {
        ...
        public virtual void Delete(TEntity entity)   //here
        {
